...
public class LotteryUtil {
    ...
    public static int lottery(List<Double> orignalRates) {
        ...
        System.out.println(sortOrignalRates.indexOf(nextDouble));
    ...
    public static void main(String[] args) {
        ...
        //原始概率列表
        List<Double> orignalRates = new ArrayList<Double>(10);
        orignalRates.add(0.0);
        orignalRates.add(8.0);
        ...
        int orignalIndex = LotteryUtil.lottery(orignalRates); //抽到的奖品索引
            ...
            //得到奖品
        String t = giftList.get(orignalIndex);
